...
xi.msg.basic =
{
    ...
    RANGED_ATTACK_SQUARE   = 576, -- <attacker>'s ranged attack hits <defender> squarely for <number> point(s) of damage!
    RANGED_ATTACK_TRUE     = 577, -- <attacker>'s ranged attack strikes true, pummeling <defender> for <number> point(s) of damage!

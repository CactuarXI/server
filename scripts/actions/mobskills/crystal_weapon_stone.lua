...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    damage = xi.mobskills.mobMagicalMove(mob, target, skill, damage, xi.element.EARTH, dmgmod, xi.mobskills.magicalTpBonus.MAB_BONUS, 1)
    ...
    if mob:getName() == 'Suttung' or mob:getName() == 'Lost_Suttung' then
        if damage > 0 then
            xi.mobskills.mobPhysicalStatusEffectMove(mob, target, skill, xi.effect.PETRIFICATION, 1, 0, 25)
        end
    end

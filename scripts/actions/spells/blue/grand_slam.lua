...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    params.numhits = 1
    params.multiplier = 2.5 -- Default: 1.0
    params.tp150 = 2.75 -- Default: 1.0
    params.tp300 = 3.0 -- Default: 1.0
    params.azuretp = 4.0 -- Default: 1.0
    params.duppercap = 40 -- 33
    params.str_wsc = 0.0
    params.dex_wsc = 0.0
    params.vit_wsc = 0.4 -- 0.3
    params.agi_wsc = 0.0
    params.int_wsc = 0.0
    params.mnd_wsc = 0.0
    params.chr_wsc = 0.0

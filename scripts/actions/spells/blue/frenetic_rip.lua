...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    params.numhits = 3
    params.multiplier = 2.75 -- Default: 1.36
    params.tp150 = 2.90 -- Default: 2.08
    params.tp300 = 3.15 -- Default: 2.36
    params.azuretp = 4.0 -- Default: 2.61
    params.duppercap = 75 -- Default: 75
    params.str_wsc = 0.2
    params.dex_wsc = 0.2
    params.vit_wsc = 0.0
    params.agi_wsc = 0.0

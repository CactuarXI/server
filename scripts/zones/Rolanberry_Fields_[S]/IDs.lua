...
zones[xi.zone.ROLANBERRY_FIELDS_S] =
{
    text =
    {
        ...
        VOIDWALKER_DESPAWN            = 7992, -- The monster fades before your eyes, a look of disappointment on its face.
        VOIDWALKER_NO_MOB             = 8047, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 8048, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 8049, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 8050, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 8052, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 8053, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        ...
        I_CANNOT_HELP_YOU_NOW         = 7235, -- I cannot help you now. I have other orders to carry out.
    },
    mob =
    {

...
zones[xi.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR     = 7667, -- Entering the battlefield for [Trial by Fire/Trial-Size Trial by Fire/Waking the Beast/Sugar-coated Directive/Trial by Fire]!
    },
    mob =
    {

...
--  Attachment                    Modifier                                0,       1,     2,     3    Optic Fiber Bonus
    ...
    ['auto-repair_kit_iv']  = { { xi.mod.HPP,                         {    20,    20,    20,    20 }, false },
                                { xi.mod.REGEN,                       {   nil,   nil,   nil,   nil }, true  }, },
    ['barrier_module']  =     { { xi.mod.AUTO_SHIELD_BASH_DELAY,      {     0,     5,    10,    20 }, false },
                                { xi.mod.SHIELD_MASTERY_TP,           {     0,    10,    15,    20 }, true  },
                                { xi.mod.SHIELDBLOCKRATE,             {    15,    20,    30,    35 }, true  }, },
    ['barrier_module_ii']  =  { { xi.mod.AUTO_SHIELD_BASH_DELAY,      {     0,    10,    15,    25 }, false },
    ...
    ['damage_gauge']        = { { xi.mod.AUTO_HEALING_THRESHOLD,      {    30,    40,    50,    75 }, true  },
     ...
     ['damage_gauge_ii']    = { { xi.mod.AUTO_HEALING_THRESHOLD,      {    35,    50,    60,    80 }, true  },
                                { xi.mod.AUTO_HEALING_DELAY,          {     3,     6,     8,    10 }, false }, },
    ...
    ['smoke_screen']        = { { xi.mod.ACC,                         {   -20,   -40,   -80,  -160 }, true  },
                                { xi.mod.RACC,                        {   -20,   -40,   -80,  -160 }, true  },
                                { xi.mod.EVA,                         {    20,    40,    80,   160 }, true  }, },

...
xi.job_utils.monk.useCounterstance = function(player, target, ability)
    ...
    target:addStatusEffect(xi.effect.COUNTERSTANCE, power, 0, 300, 0, 50)
end

xi.job_utils.monk.useDodge = function(player, target, ability)
    player:addStatusEffect(xi.effect.DODGE, 0, 0, 60) -- Default: 30
end

xi.job_utils.monk.useFocus = function(player, target, ability)
    player:addStatusEffect(xi.effect.FOCUS, 0, 0, 60) -- Default: 30
end

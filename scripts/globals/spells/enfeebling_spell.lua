...
{   --                                  1                             2          3      4    5         6       7    8          9
    ...
    [xi.magic.spell.POISON_IV     ] = { xi.effect.POISON,             xi.mod.INT,    0,   3,      175,      2,   0, true,        0 },
    [xi.magic.spell.POISON_V      ] = { xi.effect.POISON,             xi.mod.INT,    0,   3,      200,      2,   0, true,        0 },
    ...
    [xi.magic.spell.POISONGA_IV   ] = { xi.effect.POISON,             xi.mod.INT,    0,   3,      175,      2,   0, true,        0 },
    [xi.magic.spell.POISONGA_V    ] = { xi.effect.POISON,             xi.mod.INT,    0,   3,      200,      2,   0, true,        0 },

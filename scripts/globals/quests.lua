...
xi.quest.id =
{
    ...
    [xi.quest.area[xi.questLog.SANDORIA]] =
    {
        ...
        GATES_TO_PARADISE               = 18, -- + Converted
        A_SQUIRES_TEST_II               = 19, -- + Converted
        TO_CURE_A_COUGH                 = 20, -- + Converted
        TIGER_S_TEETH                   = 23, -- ±
        ...
        THE_MERCHANT_S_BIDDING          = 69, -- ± Converted
    ...
    [xi.quest.area[xi.questLog.WINDURST]] =
    {
        ...
        MIHGO_S_AMIGO                   = 25, -- + Converted
        ROCK_RACKETEER                  = 26, -- + Converted
        CHOCOBILIOUS                    = 27, -- +
        TEACHERS_PET                    = 28, -- + Converted
        REAP_WHAT_YOU_SOW               = 29, -- + Converted

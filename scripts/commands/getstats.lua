...
commandObj.onTrigger = function(player, option)
    ...
    switch(option): caseof
    {
        ...
        ['offensive'] = function()
            ...
            player:printToPlayer(string.format('Weapon Delay: %i ', math.ceil((target:getDelay() / 1000) * 60)), xi.msg.channel.SYSTEM_3)
        ...
        ['defensive'] = function()
            ...
            player:printToPlayer(string.format('Ranged Attack Base: %i ', target:getMod(xi.mod.RATT)), xi.msg.channel.SYSTEM_3)
            player:printToPlayer(string.format('Total Ranged Attack: %i ', target:getStat(xi.mod.RATT)), xi.msg.channel.SYSTEM_3)
